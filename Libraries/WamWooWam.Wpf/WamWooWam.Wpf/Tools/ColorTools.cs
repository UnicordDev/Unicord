...
namespace WamWooWam.Wpf.Tools
{
    public static class ColorExtensions
    {
        ...
        {
            var c = color.GetDrawingColour();

            var lighting = c.GetBrightness();
            ...
            var tintedColor = ColorHelper.FromHsl(color.A, c.GetHue(), c.GetSaturation(), lighting);
        ...
        public static System.Drawing.Color GetDrawingColour(this Color c) => System.Drawing.Color.FromArgb(c.A, c.R, c.G, c.B);
    }
    ...
    public static class ColorHelper
    {
        ...
        public static Color FromHsl(int alpha, float hue, float saturation, float lighting)
        {
            ...
            if (0 == saturation)
            {
                return Color.FromArgb((byte)alpha, (byte)Convert.ToInt32(lighting * 255), (byte)Convert.ToInt32(lighting * 255), (byte)Convert.ToInt32(lighting * 255));
            }
            ...
            {
                case 1:
                    return Color.FromArgb((byte)alpha, (byte)iMid, (byte)iMax, (byte)iMin);
                case 2:
                    return Color.FromArgb((byte)alpha, (byte)iMin, (byte)iMax, (byte)iMid);
                case 3:
                    return Color.FromArgb((byte)alpha, (byte)iMin, (byte)iMid, (byte)iMax);
                case 4:
                    return Color.FromArgb((byte)alpha, (byte)iMid, (byte)iMin, (byte)iMax);
                case 5:
                    return Color.FromArgb((byte)alpha, (byte)iMax, (byte)iMin, (byte)iMid);
                default:
                    return Color.FromArgb((byte)alpha, (byte)iMax, (byte)iMid, (byte)iMin);
            }
        }
    }
}
